...
module.exports = {
    ...
    initialize: function (config) {
        ...
        curl.defaults.baseURL = setBaseUrl(config.sandbox || config.Test)
    ...
    request: async function (to, amount, websocket_channel, firstname, lastname, email, direct, stateData,callback,partnerId) {
        try {
